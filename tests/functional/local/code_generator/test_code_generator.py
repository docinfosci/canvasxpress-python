...
# Commented out as Menna's work has spilled into develop but the tests are not yet fixed.
# def test_code_generator():
#     example_json_path = os.path.join(os.path.dirname(__file__), "test.json")
#     candidate = generate_canvasxpress_code_from_json_file(example_json_path)
#
#     valid_result_path = os.path.join(os.path.dirname(__file__), "valid_result.txt")
#
