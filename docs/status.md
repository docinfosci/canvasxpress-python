...
#### 2022 May 13: afterRender Function Support for Dash
CanvasXpress supports the `afterRender` parameter by which CanvasXpress Javascript functions can be specified.  The 
React edition does not support afterRender values, but now CanvasXpress for Python's Dash implementation enables these
functions to be declared and used.  An example of where afterRender is useful is the histogram charts, which uses the
function `createHistogram(false, null, null)` to apply a histogram illustration:
...
```python
 ...
 cx = CanvasXpress(
   ...
   data = {
     ...
     "z": {
       "Organ": [
         "Stomach","Stomach","Stomach","Stomach","Stomach","Stomach","Stomach","Stomach","Stomach","Stomach","Stomach",
         "Stomach","Stomach","Bronchus","Bronchus","Bronchus","Bronchus","Bronchus","Bronchus","Bronchus","Bronchus",
         "Bronchus","Bronchus","Bronchus","Bronchus","Bronchus","Bronchus","Bronchus","Bronchus","Bronchus","Colon",
         "Colon","Colon","Colon","Colon","Colon","Colon","Colon","Colon","Colon","Colon","Colon","Colon","Colon",
         "Colon","Colon","Colon","Ovary","Ovary","Ovary","Ovary","Ovary","Ovary","Breast","Breast","Breast","Breast",
     ...
     "y": {
       ...
       "data": [
         [124], [42], [25], [45], [412], [51], [1112], [46], [103], [876], [146], [340], [396], [81], [461], [20], [450], 
         [246], [166], [63], [64], [155], [859], [151], [166], [37], [223], [138], [72], [245], [248], [377], [189], 
         [1843], [180], [537], [519], [455], [406], [365], [942], [776], [372], [163], [101], [20], [283], [1234], [89], 
         [201], [356], [2970], [456], [1235], [24], [1581], [1166], [40], [727], [3808], [791], [1804], [3460], [719]
       ],
       "desc": ["days"]
     }
   },
