...
- canvasxpress_version (string; optional):
...
- width (string; optional):
    The element width."""
    @_explicitize_args
    def __init__(self, id=Component.REQUIRED, data=Component.UNDEFINED, config=Component.UNDEFINED, events=Component.UNDEFINED, after_render=Component.UNDEFINED, canvasxpress_version=Component.UNDEFINED, width=Component.UNDEFINED, height=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'after_render', 'canvasxpress_version', 'config', 'data', 'events', 'height', 'width']
        self._type = 'CXDashElement'
        self._namespace = 'cxdash'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'after_render', 'canvasxpress_version', 'config', 'data', 'events', 'height', 'width']
