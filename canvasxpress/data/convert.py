...
class CXHtmlConvertable(ABC):
    ...
    def render_to_html_parts(self) -> dict:
        ...
        Returns:
            dict: A `dict` representation of the object with each component of the
...
class CXDictConvertable(ABC):
    ...
    def render_to_dict(self, **kwargs) -> dict:
        ...
        Args:
            kwargs: Keyword arguments that can be supplied to facilitate rendering
                decisions.
...
class CXListConvertable(ABC):
    ...
    def render_to_list(self, **kwargs) -> list:
        ...
        Returns:
            list: A list representation of the object, such as what might be
                needed for a JSON export.
        """
        pass
...
class CXJavascriptConvertable(ABC):
    ...
    def render_to_js(self) -> str:
        ...
        Returns:
            str: A string representation of the object in a form that can be used
